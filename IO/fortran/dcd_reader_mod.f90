...
!----------------------------------------------------------------------------------------------------------------- 
    ...
    subroutine call_read_dcd_header(dcdfile,strleng,total_atoms,total_frames) bind(c,name="call_dcd_header")
        implicit none 
    ...
    subroutine call_read_dcd_traj(dcdfile,strleng,total_atoms,current_frame,box,xyz) bind(c,name="call_dcd_traj")
        implicit none 
